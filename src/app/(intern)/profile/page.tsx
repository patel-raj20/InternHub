...
export default function InternProfilePage() {
  ...
  const fetchProfileData = async () => {
    ...
    setIsLoading(true);
    try {
      const profileData = await graphqlService.getInternByUserId(userId);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-3xl font-black tracking-tighter uppercase">Personal Profile</h1>
          </div>
          <p className="text-muted-foreground font-medium ml-1">View and manage your internship details.</p>
        </div>
      </div>

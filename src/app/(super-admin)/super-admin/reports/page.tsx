    ...
    <div className="container mx-auto py-8 px-4">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black uppercase tracking-tighter">Organization Interns</h1>
          <p className="text-muted-foreground mt-1 text-[10px] font-black uppercase tracking-widest opacity-60">Organization-specific intern oversight and analytical data view.</p>
        </div>
      </div>

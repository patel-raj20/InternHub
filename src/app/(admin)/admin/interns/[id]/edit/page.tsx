...
export default function AdminEditInternPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Pass custom redirect path for Admin role
  return <EditInternClient intern={{ ...data.intern, redirectPath: "/admin/interns" } as any} departments={data.departments} />;
}
